...
export function Hero({ changePage }: { changePage: (page: string) => void }) {
  return (
    ...
    >
      ...
      <div
        className="glow-accent pointer-events-none absolute -top-24 left-1/2 h-[420px] w-[420px] -translate-x-1/2 opacity-70"
        aria-hidden="true"
      />
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          <p className="slide-up flex items-center gap-2 font-mono text-xs text-accent sm:text-sm">
            <span className="text-text-secondary">~/kenshie</span>
          ...
          <p className="slide-up stagger-3 mt-6 max-w-xl text-base leading-relaxed text-text-secondary md:text-lg text-pretty">
            I help small and medium businesses build a strong online presence
            through modern, professional websites that attract customers and
